...
public class EmpleadoController {
    ...
    public static void crear(Context ctx) {
        try {
            ...
            String direccion = body.get("Direccion") != null ? body.get("Direccion") : body.get("Dirección");
            String casa = body.get("Casa_Apartamento");
            String cp = body.get("Codigo_Postal");
            String ciudad = body.get("Ciudad");
            String estado = body.get("Estado");
            String telefono = body.get("Telefono") != null ? body.get("Telefono") : body.get("Teléfono");
